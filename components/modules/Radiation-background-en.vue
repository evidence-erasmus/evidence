<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article" lang="en" style="hyphens: auto;">
            ...
            <h2 id="section-1">1. Radiation is part of our daily lives</h2>
            ...
            <UiContentImage
                ...
                :elevated="true">
                <template #caption>
                    <b>Figure 1.</b> Electromagnetic Spectrum <sup><a href="https://www.science-sparks.com/what-is-the-electromagnetic-spectrum/" target="_blank" rel="noopener noreferrer">[1]</a></sup> 
                </template>
            </UiContentImage>
            ...
            <p>
                The <span class="e-term font-serif">sievert</span> (symbol: <b>Sv</b>) is a unit of ionising radiation dose in the International System of Units (SI) and measures the health effect of ionising radiation on the human body. The sievert is important in dosimetry and radiation protection. It is named after Rolf Maximilian Sievert, a Swedish medical physicist renowned for his work on radiation dose measurement and research into the biological effects of radiation.
            </p>
            ...
            <p>
                The sun sends energy to Earth in a few different ways: visible light that we can see, infrared radiation that feels like heat, and rays of UV radiation that we cannot see or feel. UV rays cause skin ageing and eye damage and can lower your body's ability to fight off illness. Shorter wavelength UV rays (so-called UVB) cause sunburns and skin cancer. Skin cancer incidence in the EU reaches 90,000 new cases annually, more than half of them in Sweden. It is one of the fastest-rising forms of cancer <sup><a href="https://ec.europa.eu/research/health/pdf/factsheets/melanoma_skin_cancer.pdf" target="_blank" rel="noopener noreferrer">[5]</a></sup>.
            </p>
            ...
            <p>
                According to several expert agencies – there is nothing to suggest 5G millimetre waves have a significant health risk <sup><a href="http://emfhealth.info/research-expert-opinions.cfm" target="_blank" rel="noopener noreferrer">[7]</a></sup>. However, many experts say more quality research is needed. 5G high-band frequencies are still non-ionizing, so this radiation does not have enough energy to break apart DNA and directly cause changes to cells that could lead to cancer. Most studies published on the use of traditional cell phone service in the radio-frequency range have not found a link with the development of tumours <sup><a href="https://www.cancer.org/cancer/cancer-causes/radiation-exposure/cellular-phones.html" target="_blank" rel="noopener noreferrer">[8]</a></sup>. Tissue heating is the primary interaction mechanism between radiofrequency fields and the human body. Radiofrequency exposure levels from current technologies (2, 3, 4G) result in negligible temperature rise (a few tenths of a degree) in the human body.
            </p>

            <p>
                However, some of the scientists mentioned above point out that, in the particular case of 5G, the issue is not the potency, but the pulse, the frequency to which the whole population will be exposed due to the dense network of antennas and the estimated billions of simultaneous connections. Studies show that pulsed electromagnetic fields (EMF) are, in most cases, more biologically active and, therefore, more dangerous than non-pulsed EMF <sup><a href="https://www.europarl.europa.eu/RegData/etudes/BRIE/2020/646172/EPRS_BRI(2020)646172_EN.pdf" target="_blank" rel="noopener noreferrer">[9]</a></sup>.
            </p>

            <p>
                Thus, some experts suspect that the radiation from these devices could damage cells via another biological mechanism, such as oxidative stress in cells, which leads to inflammation, and cell and tissue damage. There have been opinions that short-term exposure can have adverse physiological effects on the peripheral nervous system, the cardiovascular system <sup><a href="https://blogs.scientificamerican.com/observations/we-have-no-reason-to-believe-5g-is-safe/" target="_blank" rel="noopener noreferrer">[10]</a></sup> and the immune system (affecting the immune response in our skin) <sup><a href="https://www.investigate-europe.eu/en/posts/5g-covid-conspiracy" target="_blank" rel="noopener noreferrer">[11]</a></sup>. Nevertheless, those opinions are drawn from a few studies, mainly focussed on WiFi frequency bands (2.4 GHz and 5 GHz). <sup><a href="https://www.sciencedirect.com/science/article/pii/S0013935118300355" target="_blank" rel="noopener noreferrer">[12]</a></sup>
            ...
            <div class=" e-card">
                <div class="md:grid md:grid-cols-2 gap-4 md:items-end">
                    <UiContentImage
                        ...
                        :elevated="false" >
                        <template #caption>
                            UK <sup><a href="https://www.phe-protectionservices.org.uk/radiationandyou/" target="_blank" rel="noopener noreferrer">[14]</a></sup>
                        </template>
                    </UiContentImage>
                    <UiContentImage
                        ...
                        :elevated="false" >
                        <template #caption>
                            DE <sup><a href="https://www.euronuclear.org/glossary/radiation-exposure-average-in-germany/" target="_blank" rel="noopener noreferrer">[15]</a></sup>
                        </template>
                    </UiContentImage>
                </div>
                <p class="text-sm italic text-center"><b>Figure 2.</b> Contribution of different radiation sources to average population annual effective radiation dose</p>
            </div>
            ...
            <p>
                The radiation is emitted by external sources, and a person is only exposed during the procedures. There is no radioactive effect afterwards <sup><a href="https://www.cdc.gov/nceh/radiation/x-rays.html" target="_blank" rel="noopener noreferrer">[16]</a></sup>. However, during nuclear medicine procedures, patients take radiopharmaceuticals that will be used in their treatment or procedure. All radionuclides have a "half-life," which is the time it takes to decay away. Patients may continue to emit detectable radiation levels for different periods after different treatments. Tc-99m (technetium-99m) is detectable for 3-4 days; fluorine-18 (F-18) that the most common radioisotope used, is detectable for a day; technetium-99 m (Tc-99m) and thallium-201 (Tl-201) or a combination of both that are used in myocardial perfusion (blood flow) imaging remain detectable for few days and up to a month, respectively. Iodine-131 (I-131), used to treat hyperthyroidism, thyroid cancer and lymphoma, may remain detectable for as long as three months after treatment <sup><a href="https://www.snmmi.org/ClinicalPractice/content.aspx?ItemNumber=4825" target="_blank" rel="noopener noreferrer">[16]</a></sup>. During that period small amount of ionising radiation is emitted by our body; thus, one can say being radioactive. However, the emitted amounts of radiation are low and nuclear medicine, as the non-invasive method, has several benefits compared to invasive methods. Much higher doses are given in radiation therapy used to treat cancerous cells in the body. The typical doses are around 50,000 mSv divided into multiple smaller doses over a few months. The most common type of radiation therapy is external-beam radiation therapy, where patients get radiation doses from medical equipment <sup><a href="https://www.cancer.net/navigating-cancer-care/how-cancer-treated/radiation-therapy/understanding-radiation-therapy" target="_blank" rel="noopener noreferrer">[18]</a></sup>. After procedures, no radiation is released.
            </p>
            ...
            <UiContentImage
                ...
                credits="Motarjemi Y, Moy G, Todd ECD. Encyclopedia of Food Safety: Elsevier (2014)."
                :elevated="true">
                <template #caption>
                    <b>Figure 4.</b> Commercial scale, high-capacity, and carrier-type cobalt-60 food irradiation facility <sup>[20]</sup> 
                </template>
            </UiContentImage>
            
            <p>
                Nowadays, people are more aware of the food they eat than at any other time in history. Even if these energies for food irradiation are too low to induce radioactivity, some people are wary of irradiated food. Even though food irradiation poses no toxicological, microbiological, or nutritional problems <sup><a href="https://academic.oup.com/cid/article/33/3/376/278043" target="_blank" rel="noopener noreferrer">[21]</a></sup>, it does reduce vitamin levels in foods, especially for the B group vitamins. However, during traditional cooking, similar vitamin loss can be observed <sup><a href="https://academic.oup.com/cid/article/33/3/376/278043" target="_blank" rel="noopener noreferrer">[22]</a></sup>. Food irradiation has nothing to do with radioactive contamination, as food does not come in contact with radioactive material during irradiation and cannot be contaminated this way.
            </p>
            ...
            <UiContentImage
                ...
                :elevated="true">
                <template #caption>
                    <b>Figure 5.</b> This cobalt-60 irradiation facility is used to test irradiation as a tool for food safety. 
                </template>
            </UiContentImage>
            ...
            <UiContentImage
                ...
                :elevated="true">
                <template #caption>
                    <b>Figure 6.</b> UVA and UVB effects on human skin <sup><a href="https://www.mdanderson.org/publications/focused-on-health/what-s-the-difference-between-uva-and-uvb-rays-.h15-1592991.html" target="_blank" rel="noopener noreferrer">[26]</a></sup>
                </template>
            </UiContentImage>
            
            
            <h2 id="section-nuc">Fears of Nuclear energy</h2>
            ...
            <h2 id="section-myths">
                Facts related to common myths about nuclear energy <sup><a href="https://funginstitute.berkeley.edu/news/op-ed-lets-dispel-the-myths-about-nuclear-energy/" target="_blank" rel="noopener noreferrer">[29]</a></sup> <sup><a href="https://ourworldindata.org/what-is-thesafest-form-of-energy" target="_blank" rel="noopener noreferrer">[30]</a></sup>
            </h2>
            
            
            <h3><span class="text-rose-400">Myth 1:</span> Nuclear energy is not safe</h3>

            <p>
                The three accidents of nuclear reactors in Three Mile Island, Chernobyl and Fukushima Daiichi, occurred over a time frame of 65 years. Of these three accidents, two had no fatalities related to nuclear radiation and Chernobyl had about 50 fatalities immediately related to nuclear radiation <sup><a href="https://www.who.int/news/item/05-09-2005-chernobyl-the-true-scale-of-the-accident" target="_blank" rel="noopener noreferrer">[31]</a></sup>. Although a further 4,000 fatalities resulting from cancer might be related to the Chernobyl accident, the overall fatality rate remains lower than that attributed to other forms of energy production. “The death toll from nuclear energy is 442 times fewer relative to brown coal per unit of energy, even with radioactive exposure deaths included <sup><a href="https://ourworldindata.org/what-is-thesafest-form-of-energy" target="_blank" rel="noopener noreferrer">[32]</a></sup>.”
            </p>

            <h3><span class="text-rose-400">Myth 2:</span> Nuclear energy contributes to carbon emissions and thus leads to atmospheric pollution and global warming</h3>
            ...
            <h3><span class="text-rose-400">Myth 3:</span> Nuclear waste needs to be stored for 100000 years</h3>
            ...
            <h3>
                <span class="text-rose-400">Myth 4:</span> Nuclear plants emit dangerous amounts of radiation
            </h3>
            ...
            <h3><span class="text-rose-400">Myth 5:</span> Exposure to radiation only occurs from a nuclear power station</h3>
            ...
            <h3><span class="text-rose-400">Myth 6:</span> We don't need nuclear power in the EU</h3>
            ...
            <h3><span class="text-rose-400">Myth 7:</span> Nuclear plants are ageing and inefficient</h3>
            ...
            <h3><span class="text-rose-400">Myth 8:</span> Nuclear power plants can explode</h3>
            ...
            <h3><span class="text-rose-400">Myth 9:</span> Nuclear waste cannot be safely transported.</h3>
            ...
            <h3><span class="text-rose-400">Myth 10:</span> Nuclear plant workers are radioactive themselves.</h3>
