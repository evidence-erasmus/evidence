...
<template>
    ...
    <div class="flex flex-col items-start 
        ...
        <section class="e-article print:not-prose" :lang="locale" style="word-wrap: break-word;overflow-wrap: break-word; -webkit-hyphens: auto; -moz-hyphens: auto; hyphens: auto;">
            ...
            <h1 class="mb-2">{{ t('inquiry.cc_myth5.title') }}</h1>
            ...
            <textarea id="expHypothesis" class="textarea textarea-bordered block w-full mb-16" placeholder="✍️" rows="5"
            ...
            <div class="e-card w-[90vw] transform -translate-x-[5vw] mb-16" >
                <ToolsDynamicTableFull
            ...
            <textarea id="expColl" class="textarea textarea-bordered block w-full mb-16" placeholder="✍️" rows="5"
            ...
            <label class="block mb-2"><b>{{ t('inquiry.cc_myth5.flicc_label') }}</b></label>
            ...
            <!-- <div style="transform:translateX(-5vw)" class="w-[90vw] e-card mb-16">
                <ToolsFliccTable :storeToUpdate="climateMyth5Answers" key="ccmyth5flicc" />
            </div> -->
            <UiFullWidth class="e-card">
                <div>
                    <ClientOnly>
                        <ToolsFlicc2Table :storeToUpdate="climateMyth5Answers" key="ccmyth5flicc" />
                    </ClientOnly>
                </div>
            </UiFullWidth>
