<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article print:not-prose" lang="en" style="hyphens:auto">
            ...
            <section id="s3">
                <h2 id="s3t">Expected prior knowledge about viruses</h2>
            ...
            <section id="s5">
                <h2 id="s5t">Requirements for the physical environment</h2>
