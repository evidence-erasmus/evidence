<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article print:not-prose" lang="en" style="hyphens:auto">
            ...
            <hr class="mt-10 mb-40 print:my-10" />
            <h2 id="section-3">Expected prior knowledge about viruses</h2>
            ...
            <p>
                The belief that <b>masks are pointless in preventing upper respiratory diseases</b> (e.g. COVID-19) can be developed further into a testable hypothesis or research question. It would be good to use different types of masks (e.g. textile masks, N95, surgical face masks) in this experiment to get more varied and exciting results. Practical examples of how it can be operationalized in the classroom - can be used if students are less experienced with the open inquiry format (there exist two versions, one open and the other in a guided / structured inquiry format).
            </p>
            ...
            <UiContentImage src="https://evidence.onkel.ee/assets/viruses-09__pulse-oxymeter.webp" :elevated="true" :zoom="true" credits="https://www.pexels.com/photo/a-person-using-a-pulse-oximeter-4390162/">
                <template #caption>
                    <b>Figure 2.</b> Use of a pulse oximeter
                </template>
            </UiContentImage>
            ...
            <p>
                <b>Table 2.</b> Story cards and respective info cards on the topic “Vaccination” (Activity 6)
            </p>
            ...
            <p>
                All myths are backed up by <NuxtLink :to="localePath('/viruses/background')">Scientific background information</NuxtLink>, which explains the state-of-the-art science behind it and enables the teacher to get a quick overview of the science covered by the "Viruses" module but could also be used as learning material for students to recall virus-related knowledge.
            </p>
