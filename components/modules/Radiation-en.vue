<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article print:not-prose" lang="en" style="hyphens: auto;">
            ...
            <section id="s3">
                <h2 id="s3t">Expected prior knowledge about radiation</h2>
            ...
            <section id="s5">
                <h2 id="s5t">Requirements for physical environment</h2>
            ...
            <section id="s7"> 
                ...
                <p>
                    <b>Activity 2</b> should help students narrow down their chosen myth into a hypothesis/research question that can be confirmed/answered <b>(Activity 3)</b>. Further, this step can be enacted in the following two ways:
                </p>
                <ol>
                    <li>
