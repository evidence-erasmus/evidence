<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article" lang="en" style="hyphens:auto">
            ...
            <section id="s1">
                <h2 id="s1t">1. Viruses versus bacteria</h2>
            ...
            <section id="s2">
                <h2 id="s2t">2. Why do antibiotics not kill viruses?</h2>
            ...
            <section id=s3>
                <h2 id="s3t">3. How vaccines work</h2>
            ...
            <section id="s4">
                <h2 id="s4t">4. The process of developing vaccines, vaccines safety</h2>
            ...
            <section id="s5">
                <h2 id="s5t">5. Masks against viruses and bacteria</h2>
            ...
            <section id="s6">
                <h2 id="s6t">6. Viruses and hand hygiene</h2>
            ...
            <section id="s7">
                ...
                <h3><span class="text-rose-400">Myth 3:</span> Immunity acquired through a disease is better than immunity acquired through vaccination</h3>
                <p>
