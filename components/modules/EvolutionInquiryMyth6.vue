<script setup>
    ...
    const studentAnswers = useStudentEvolutionGuidedMyth6();
...
<template>
    ...
    <div class="flex flex-col items-start 
        ...
        <section class="e-article print:not-prose" :lang="locale" style="word-wrap: break-word; overflow-wrap: break-word; -webkit-hyphens: auto; -moz-hyphens: auto; hyphens: auto;">
            ...
            <h1 class="mb-0">{{ t('inquiry.ev_myth6.title') }}</h1>
            <h5 class="font-normal uppercase leading-tight">{{ t('inquiry.ev_myth6.subtitle') }}</h5>
            ...
            <p>
                {{ t('inquiry.ev_myth6.justification.text') }}
            </p>

            <label for="q1" class="block mb-2">
                <b>{{ t('inquiry.ev_myth6.justification.label_1') }}</b>
            </label>
            ...
            <label for="q2" class="block mb-2">
                <b>{{ t('inquiry.ev_myth6.label_2') }}</b>
            </label>
            ...
            <label for="q3" class="block mb-2">
                <b>{{ t('inquiry.ev_myth6.label_3') }}</b>
            </label>
            ...
            <UiCardInfo icon="mdi:question-mark-circle" theme="sky-500">
                <h4 class="my-4 leading-tight">
                    {{ t('inquiry.ev_myth6.question') }}
                </h4>
            </UiCardInfo>
            

            <p>
                {{ t('inquiry.ev_myth6.sources_text') }}
            </p>
            <ol class="leading-tight mb-16">
                <li v-for="li in tm('inquiry.ev_myth6.sources')">
                    <a :href="rt(li.url)" target="_blank" rel="noopener noreferrer">{{ rt(li.label) }}</a>
                </li>
            </ol>

            <label for="q4" class="block mb-2">
                <b>{{ t('inquiry.ev_myth6.label_4') }}</b>
            </label>
            ...
            <i18n-t tag="p" keypath="inquiry.ev_myth6.reliability.text" scope="global">
                <template #link>
                    <NuxtLink to="../../tools/reliability-assessment" target="_blank" class="btn btn-sm btn-neutral text-white no-underline"><Icon name="mdi:tools" size="18" />
                        {{ t('inquiry.ev_myth6.reliability.link') }}
                    </NuxtLink>
                </template>
            </i18n-t>
            
            <label class="block mb-2">
                <b>{{ t('inquiry.ev_myth6.reliability.label') }}</b>
            </label>
            <div class="e-card">
                <ClientOnly>
