<script setup>
    import { useStudentEvolutionGuidedMyth3 } from '~~/store/useStudentEvolutionGuidedMyth3.js'; 
    const studentAnswers = useStudentEvolutionGuidedMyth3();
...
<template>
    ...
    <div class="flex flex-col items-start 
        ...
        <section class="e-article print:not-prose" :lang="locale" style="word-wrap: break-word; overflow-wrap: break-word; -webkit-hyphens: auto; -moz-hyphens: auto; hyphens: auto;">
            ...
            <h1 class="mb-0">{{ t('inquiry.ev_myth3.title') }}</h1>
            <h5 class="font-normal uppercase leading-tight">{{ t('inquiry.ev_myth3.subtitle') }}</h5>
        

            <UiCardInfo theme="rose-400" icon="game-icons:unicorn" class="my-16">
                <h4 class="leading-tight my-2">
                    {{ t('inquiry.ev_myth3.myth.text') }} {{ t('inquiry.ev_myth3.myth.myth') }}
                </h4>
            </UiCardInfo>
