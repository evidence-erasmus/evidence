<template>
    <div class="flex flex-col items-start 
        ...
        xl:gap-10
        2xl:gap-20" lang="et" style="hyphens: auto;">
        <ClientOnly>
        ...
        <section class="e-article" lang="sv" style="hyphens: auto;">
            ...
            <ol>
                <li class="leading-tight">
                    <b>elektromagnetisk strålning</b>, såsom radiovågor, mikrovågor, infrarött ljus, synligt ljus, ultraviolett ljus, röntgenstrålning och gammastrålning;
                </li>
                <li class="leading-tight">
                    <b>partikelstrålning</b>, såsom alfastrålning (α), betastrålning (β), protonstrålning och neutronstrålning (se figur 1).
                </li>
            </ol>
            ...
            <UiContentImage
                ...
                :elevated="true">
                <template #caption>
                    <b>Figur 1.</b> Elektromagnetiskt spektrum <sup><a href="https://www.science-sparks.com/what-is-the-electromagnetic-spectrum/" target="_blank" rel="noopener noreferrer">[1]</a></sup> 
                </template>
            </UiContentImage>
            ...
            <ul>
                <li>
                    <b>Mikrovågsstrålning</b> för telekommunikation och uppvärmning av mat.
                </li>
                <li>
                    <b>Infraröd strålning</b> för infraröda lampor och för att hålla maten varm på restauranger.
                </li>
                <li>
                    <b>Radiovågor</b> för radiosändningar.
                </li>
            </ul>
            ...
            <p>
                Mikrovågsugnar använder elektromagnetisk strålning för att värma mat. Den icke-joniserande strålningen som används i en mikrovågsugn gör inte maten radioaktiv. Mikrovågor produceras endast när ugnen är igång. Mikrovågorna som produceras inuti ugnen absorberas av maten och producerar den värme som tillagar maten. Mikrovågsugnar är konstruerade för att säkerställa att elektromagnetisk strålning inte lämnar ugnen.<sup><a href="https://www.epa.gov/radtown/non-ionizing-radiation-used-microwave-ovens" target="_blank" rel="noopener noreferrer">[7]</a></sup>
            </p>
            ...
            <p>
                <span class="e-term font-serif">Sievert</span> (symbol: <b>Sv</b>) är en enhet för storheterna ekvivalent dos och effektiv dos i det Internationella måttenhetssystemet (SI). Dessa storheter används när man vill uppskatta hur stor skaderisken är för en människa eller annan levande organism som blivit utsatt för joniserande strålning. Den är uppkallad efter Rolf Sievert, en svensk medicinsk fysiker känd för sitt arbete med stråldosmätning och forskning om strålningens biologiska effekter. Sievert är en väldigt stor enhet, så det är vanligt att ange dos med prefix som millisievert, mSv, eller mikrosievert, µSv.
            </p>
            ...
            <ul class="leading-tight">
                <li>5 µSv - En timmes flygresa på 11 000 m höjd.</li>
                <li>0,01 mSv – Tandröntgen.</li>
                <li>0,1 mSv – Mammografiundersökning.</li>
                <li>0,3 mSv – Kosmisk strålning per år från rymden.</li>
                ...
                <li>3–4 Sv – 50% chans att överleva, procenten varierar bl.a beroende på ålder och hälsa.</li>
            </ul>
            ...
            <p>
                Under de senaste åren har elever i allmänhet blivit mer och mer intresserade av strålning <sup><a href="https://doi.org/10.1119/1.4893090" target="_blank" rel="noopener noreferrer" title="Neumann, S. (2014). Three Misconceptions About Radiation — And What We Teachers Can Do to Confront Them, Physics Teacher, 52, 357;">[9]</a></sup>. Mobiltelefoner, moderna spelkonsoler och WiFi – alla enheter som involverar viss strålning är en del av vår vardag. Folk konfronteras också ofta i media med debatter som rör olika typer av frågor om strålning: Är all strålning dålig? Är medicinsk strålning verkligen nödvändig? Orsakar strålning från mobiltelefoner cancer? Bör solarier förbjudas? Vilka är effekterna av kärnkraftsavfall?
            </p>
            ...
            <p>
                ...
                <!-- <sup><a href="https://doi.org/10.1119/1.4893090" target="_blank" rel="noopener noreferrer" title="Neumann, S. (2014). Three Misconceptions About Radiation — And What We Teachers Can Do to Confront Them, Physics Teacher, 52, 357;">[10]</a></sup> -->
            </p>
            ...
            <p>
                Enligt flera expertbyråer finns det inget som tyder på att 5G-millimetervågor medför en betydande hälsorisk <sup><a href="http://emfhealth.info/research-expert-opinions.cfm" target="_blank" rel="noopener noreferrer">[7]</a></sup>, men många experter säger att det behövs mer forskning. 5G-högbandsfrekvenser är fortfarande icke-joniserande, så denna strålning har inte tillräckligt med energi för att bryta isär DNA och direkt orsaka förändringar i celler som kan leda till cancer. De flesta studier som publicerats om användningen av traditionella mobiltelefonitjänster inom radiofrekvensområdet har inte hittat ett samband med utvecklingen av tumörer <sup><a href="https://www.cancer.org/cancer/cancer-causes/radiation-exposure/cellular-phones.html" target="_blank" rel="noopener noreferrer">[8]</a></sup>. Vävnadsuppvärmning är den primära påverkan av radiofrekventa fält på människokroppen. Radiofrekvensexponeringsnivåer från nuvarande teknologier (2, 3, 4, 5G) resulterar i försumbar temperaturökning (några tiondelar av en grad) i människokroppen.
            </p>

            <p>
                Några av forskarna som nämns ovan påpekar att, i det speciella fallet med 5G, är problemet inte styrkan och frekvensen utan pulser i fältet som hela befolkningen kommer att exponeras för på grund av det täta nätverket av antenner och uppskattningen av miljarder samtidiga anslutningar. Studier visar att pulserande elektromagnetiska fält i de flesta fall är mer biologiskt aktiva och därför farligare än icke-pulserande EMF <sup><a href="https://www.europarl.europa.eu/RegData/etudes/BRIE/2020/646172/EPRS_BRI(2020)646172_EN.pdf" target="_blank" rel="noopener noreferrer">[13]</a></sup>.
            </p>

            <p>
                Vissa experter misstänker alltså att strålningen från dessa enheter kan skada celler via en annan biologisk mekanism, såsom oxidativ stress i celler, vilket leder till inflammation och även cell- och vävnadsskador. Det har funnits åsikter om att kortvarig exponering kan ha negativa fysiologiska effekter på det perifera nervsystemet, det kardiovaskulära systemet <sup><a href="https://blogs.scientificamerican.com/observations/we-have-no-reason-to-believe-5g-is-safe/" target="_blank" rel="noopener noreferrer">[10]</a></sup> och immunsystemet (som påverkar immunförsvaret i vår hud) <sup><a href="https://www.investigate-europe.eu/en/posts/5g-covid-conspiracy" target="_blank" rel="noopener noreferrer">[11]</a></sup>. Ändå är dessa åsikter hämtade från ett fåtal studier, främst inriktade på WiFis frekvensband (2,4 GHz och 5 GHz) <sup><a href="https://www.sciencedirect.com/science/article/pii/S0013935118300355" target="_blank" rel="noopener noreferrer">[12]</a></sup>
            </p>


            <h4>
                Teknisk strålning som källa till strålningsexponering
            </h4>
            ...
            <p>
                Förutom potentiella storskaliga kärnkraftsolyckor är naturlig joniserande strålning den mest betydande bidragsgivaren till den samlade effektiva dos som mottas av världens befolkning. Den mänskliga befolkningen utsätts kontinuerligt för joniserande strålning från flera naturliga källor som kan delas in i två breda kategorier: kosmiska strålning med hög energi (kosmiskt bidrag); och radioaktiva nuklider som finns i jordskorpan (markbundet bidrag). Det terrestra bidraget består huvudsakligen av radionuklider från urans och toriums sönderfallskedjor och radioaktivt kalium. I de flesta fall är radon, en ädelgas som produceras i radioaktivt sönderfall av uran, den viktigaste bidragsgivaren till strålningsexponering <sup><a href="https://ec.europa.eu/jrc/en/research-topic/natural-radiation" target="_blank" rel="noopener noreferrer">[13]</a></sup>.
            </p>
            ...
            <div class=" e-card">
                <div class="md:grid md:grid-cols-2 gap-4 md:items-end">
                    <UiContentImage
                        src="https://evidence.onkel.ee/assets/radiation__uk.webp"
                        :elevated="false" >
                        <template #caption>
                            Storbritannien <sup><a href="https://www.phe-protectionservices.org.uk/radiationandyou/" target="_blank" rel="noopener noreferrer">[14]</a></sup>
                        </template>
                    </UiContentImage>
                    <UiContentImage
                        src="https://evidence.onkel.ee/assets/radiation__de.webp"
                        :elevated="false" >
                        <template #caption>
                            Tyskland <sup><a href="https://www.euronuclear.org/glossary/radiation-exposure-average-in-germany/" target="_blank" rel="noopener noreferrer">[15]</a></sup>
                        </template>
                    </UiContentImage>
                </div>
                <p class="text-sm italic text-center"><b>Figur 2.</b> Bidrag från olika strålkällor till genomsnittlig årlig effektiv stråldos för befolkningen</p>
            </div>
            ...
            <p>
                Strålningen avges av externa källor, och personen exponeras endast under procedurerna. Det finns ingen radioaktiv effekt efteråt  <sup><a href="https://www.cdc.gov/nceh/radiation/x-rays.html" target="_blank" rel="noopener noreferrer">[16]</a></sup>, men under nukleärmedicinska procedurer tar patienterna radiofarmaka som kommer att användas i deras behandling eller ingrepp. Alla radionuklider har en "halveringstid", vilket är den tid det tar för hälften av ämnet att sönderfalla till något annat ämne. Patienter kan fortsätta att avge detekterbara strålningsnivåer under olika perioder efter olika behandlingar. Fluor-18 (F-18) är den vanligaste radioisotopen som används och kan vara detekterbar under en dag; technetium-99 (Tc-99) och thallium-201 (Tl-201) eller en kombination av båda som används vid bildåtergivning av myokardperfusion (blodflöde) förblir detekterbara i några dagar respektive upp till en månad. Jod-131 (I-131), som används för att behandla hypertyreos, sköldkörtelcancer och lymfom, kan förbli påvisbart så länge som tre månader efter behandlingen <sup><a href="https://www.snmmi.org/ClinicalPractice/content.aspx?ItemNumber=4825" target="_blank" rel="noopener noreferrer">[17]</a></sup>. Under den perioden avges en liten mängd joniserande strålning av vår kropp. De utsända mängderna av strålning är dock låga och nuklearmedicin, som den icke-invasiva metoden, har flera fördelar jämfört med invasiva metoder. Mycket högre doser ges i strålbehandling som används för att behandla cancerceller i kroppen. De typiska doserna är cirka 50 000 mSv fördelat på flera mindre doser under några månader. Den vanligaste typen av strålbehandling är extern strålbehandling, där patienter får stråldoser från medicinsk utrustning <sup><a href="https://www.cancer.net/navigating-cancer-care/how-cancer-treated/radiation-therapy/understanding-radiation-therapy" target="_blank" rel="noopener noreferrer">[18]</a></sup>. Efter en sådan procedur frigörs ingen strålning.
            </p>
            <p>
            ...
            <UiContentImage
                src="https://evidence.onkel.ee/assets/radiation__therapy.webp"
            ...
            <p>
                Matbestrålning är den teknik som behandlar mat med joniserande strålning. Kärnan i processen är att strålning stör en cells DNA; om cellen inte kan reparera den skadan dör den. Detta kan förhindra groning i potatis, döda insekter i spannmål och frukter och inaktivera parasiter i kött. Strålning minskar avsevärt bakteriemängden i maten, medan högre doser kommer att sterilisera maten. De vanligaste radioaktiva isotoper som används är kobolt-60 och cesium-137, som producerar gammastrålar med lämplig energi.
            </p>
            ...
            <UiContentImage
                src="https://evidence.onkel.ee/assets/radiation__food-irradiation-facility.webp"
                credits="Motarjemi Y, Moy G, Todd ECD. Toiduohutuse entsüklopeedia: Elsevier (2014)."
                :elevated="true">
                <template #caption>
                    <b>Figur 4.</b> Kommersiell skala, hög kapacitet och bärartypen kobolt-60 i matbestrålningsanläggning <sup>[24]</sup> 
                </template>
            </UiContentImage>
            
            <p>
                Nuförtiden är människor mer medvetna om maten de äter än någon annan gång i historien. Även om dessa energier för matbestrålning är för låga för att inducera radioaktivitet, är vissa människor försiktiga med bestrålad mat. Även om bestrålning av livsmedel inte utgör några toxikologiska, mikrobiologiska eller näringsmässiga problem <sup><a href="https://academic.oup.com/cid/article/33/3/376/278043" target="_blank" rel="noopener noreferrer">[21]</a></sup> minskar vitaminnivåerna i livsmedel, särskilt B-gruppens vitaminer. Men under traditionell matlagning kan liknande vitaminförlust också observeras <sup><a href="https://academic.oup.com/cid/article/33/3/376/278043" target="_blank" rel="noopener noreferrer">[22]</a></sup>. Matbestrålning har inget med radioaktiv kontaminering att göra, eftersom mat inte kommer i kontakt med radioaktivt material under bestrålningen och inte kan kontamineras på detta sätt.
            </p>
            
            <UiContentImage
                src="https://evidence.onkel.ee/assets/radiation__irradiated-apples.webp"
                credits="U.S. Department of Energy"
                :elevated="true">
                <template #caption>
                    <b>Figur 5.</b> Denna kobolt-60 bestrålningsanläggning används för att testa bestrålning som ett verktyg för livsmedelssäkerhet.
                </template>
            </UiContentImage>
            ...
            <p>
                Vissa människor tror att eftersom solarier mest använder UVA-ljus är att sola på det sättet säkrare än att sola ute. Det är inte sant. Ultraviolett strålning (UV) klassificeras i UVA (våglängd från 320 till 400 nm), UVB (290 till 315 nm) och UVC (100 till 280 nm). Tidigare trodde man att UVB-strålar är mer skadliga än UVA, eftersom de framkallar solbränna kopplat till melanom. Vi vet nu att UVA-strålar orsakar för tidigt åldrande av huden och även ökar risken för hudcancer <sup><a href="https://www.health.harvard.edu/staying-healthy/is-a-tanning-bed-safer-than-sunlight" target="_blank" rel="noopener noreferrer">[23]</a></sup>. Det finns alltså inget som heter en säker eller hälsosam solbränna. Även om UVA-strålar är något mindre intensiva än UVB, penetrerar de din hud djupare. Exponering orsakar genetiska skador på celler på den innersta delen av ditt översta hudlager, där hudcancer mestadels förekommer. Huden försöker förhindra ytterligare skada genom att mörkna, vilket resulterar i en solbränna. 
            </p>
            <p>
                UVA-strålning är den primära typen av ljus som används i de flesta solarier. En gång trodde vi att det var säkert, vi vet nu att det är precis tvärtom. Bara ett tillfälle i solarium kan öka risken att utveckla hudcancer (melanom med 20 %, skivepitelcancer med 67 % och basalcellscancer med 29 %) <sup><span class="tooltip" data-tip="Wehner MR, Chren M, Nameth D, et al. International Prevalence of Indoor Tanning: A Systematic Review and Meta-analysis.JAMA Dermatol. 2014;150 (4): 390-400. doi:10.1001/jamadermatol.2013.6896."><span class="text-blue-600">[29]</span></span></sup>. American Academy of Ophthalmology rapporterar att solarier producerar 100 gånger högre UV-nivåer eller den förväntade intensiteten av ultraviolett strålning som man skulle få från solen <sup><a href="https://www.aao.org/eye-health/tips-prevention/indoor-tanning-eye-safety" target="_blank" rel="noopener noreferrer">[25]</a></sup>.
            </p>



            <UiContentImage
                src="https://evidence.onkel.ee/assets/radiation__uva-uvb.webp"
                credits="https://www.mdanderson.org/publications/focused-on-health/what-s-the-difference-between-uva-and-uvb-rays-.h15-1592991.html"
                :elevated="true">
                <template #caption>
                    <b>Figur 6.</b> UVA- och UVB-effekter på mänsklig hud <sup><a href="https://www.mdanderson.org/publications/focused-on-health/what-s-the-difference-between-uva-and-uvb-rays-.h15-1592991.html" target="_blank" rel="noopener noreferrer">[26]</a></sup>
                </template>
            </UiContentImage>
            ...
            <h2 id="section-myths">
                Vanliga myter om kärnenergi <sup><a href="https://funginstitute.berkeley.edu/news/op-ed-lets-dispel-the-myths-about-nuclear-energy/" target="_blank" rel="noopener noreferrer">[29]</a></sup> <sup><a href="https://ourworldindata.org/what-is-thesafest-form-of-energy" target="_blank" rel="noopener noreferrer">[30]</a></sup> 
            </h2>
            
            
            <h3><span class="text-rose-400">Myt 1:</span> Kärnenergi är inte säker</h3>

            <p>
                De tre olyckorna med kärnreaktorer på Three Mile Island, Tjernobyl och Fukushima Daiichi, inträffade under en tidsram på 65 år. Av dessa tre olyckor hade två av dem inga dödsfall relaterade till kärnkraftsstrålning medan Tjernobyl hade cirka 50 dödsfall omedelbart relaterade till kärnkraftsstrålning <sup><a href="https://www.who.int/news/item/05-09-2005-chernobyl-the-true-scale-of-the-accident" target="_blank" rel="noopener noreferrer">[31]</a></sup>. Även om ytterligare 4 000 dödsfall till följd av cancer kan vara relaterade till Tjernobylolyckan, är de totala dödstalen fortfarande lägre än de som tillskrivs andra former av energiproduktion. "Dödssiffran från kärnenergi är 442 gånger färre i förhållande till brunkol per energienhet, även med dödsfall i radioaktiv exponering inkluderade” <sup><a href="https://ourworldindata.org/what-is-thesafest-form-of-energy" target="_blank" rel="noopener noreferrer">[32]</a></sup>.”
            </p>

            <h3>
                <span class="text-rose-400">Myt 2:</span> Kärnenergi bidrar till koldioxidutsläpp och leder därmed till luftföroreningar och global uppvärmning
            </h3>
            ...
            <h3><span class="text-rose-400">Myt 3:</span> Kärnavfall måste lagras i 100 000 år</h3>
            ...
            <h3>
                <span class="text-rose-400">Myt 4:</span> Kärnkraftverk sänder ut mängder av farlig strålning
            </h3>
            ...
            <h3><span class="text-rose-400">Myt 5:</span> Exponering för strålning sker endast från kärnkraftverk</h3>
            ...
            <h3><span class="text-rose-400">Myt 6:</span> Vi behöver inte kärnkraft i EU</h3>

            <p>
                I EU finns en stor efterfrågan på el. Vid sidan av vind- och solenergi är kärnkraft en del av lösningen för el med låga koldioxidutsläpp. I Frankrike produceras nästan 80 % av elen av NUC. Medan vind- och solenergi är beroende av vädret, kan kärnkraft alltid tillhandahålla ström. På längre sikt kan kärnkraft användas för att producera väte för användning i bränsleceller och syntetiska flytande bränslen.
            </p>

            <h3><span class="text-rose-400">Myt 7:</span> Kärnkraftverk åldras och är ineffektiva</h3>
            ...
            <h3><span class="text-rose-400">Myt 8:</span> Kärnkraftverk kan explodera</h3>
            ...
            <h3><span class="text-rose-400">Myt 9:</span> Kärnavfall kan inte transporteras säkert.</h3>
            ...
            <h3><span class="text-rose-400">Myt 10:</span> Kärnkraftsarbetare är själva radioaktiva.</h3>
