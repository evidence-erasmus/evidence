<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article print:not-prose" lang="pt" style="hyphens: auto;">
            ...
            <section id="s1">
                <h2 id="s1t">Descrição do módulo</h2>
            ...
            <section id="s2">
                <h2 id="s2t">Objetivos de aprendizagem visados pelo módulo</h2>
            ...
            <section id="s3">
                <h2 id="s3t">Conhecimento prévio esperado sobre radiação</h2>
            ...
            <section id="s4">
                <h2 id="s4t">Estrutura do módulo</h2>
            ...
            <section id="s5">
                <h2 id="s5t">Requisitos para o ambiente físico</h2>
                <p>
            ...
            <section id="s7">
                <h2 id="s7t">Sugestões de ensino</h2>
                ...
                <p>
                    A atividade 2 deve ajudar os alunos a reduzir o mito escolhido a uma hipótese/questão de investigação que pode ser confirmada/respondida <b>(Atividade 3)</b>. Este passo pode ser executado de duas formas:
                </p>
                <ol>
                    <li>
