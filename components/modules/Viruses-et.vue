        ...
        <section class="e-article print:not-prose" lang="et" style="hyphens:auto;">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="my-0">
                            ...
                            <li>arendada edasi õpilaste arusaamist viirustest: nende levimise viisidest, erinevusest bakteritega, viirushaiguste ärahoidmisest, vaktsiinide toimemehanismidest ning ohutusest;</li>
            ...
            <section id="s3">
                ...
                <ul class="leading-tight">
                    ...
                    <li>Ravi</li>
                    <li>Vaktsiinide toimemehanismid</li>
                </ul>
            </section>
            ...
            <section id="s4">
                ...
                <section>
                    ...
                    <ModulesStructure>
                        <template #title>Tegevus 2<br />MÜÜDI VÄLJAVALIMINE</template>
                        <template #icons>
                            <div class="e-icon--rounded ">
                    ...
                    <ModulesStructure>
                        <template #title>Tegevus 6<br />SOTSIAAL-TEADUSLIKU OTSUSE TEGEMINE</template>
                        <template #icons>
                            <div class="e-icon--rounded ">
                                <Icon name="fa6-solid:people-group" class="text-white" />
                            </div>
