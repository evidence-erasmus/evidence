<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article print:not-prose" lang="et" style="hyphens:auto;">
            ...
            <h2 id="section-2">Mooduliga taotletavad õppe-eesmärgid</h2>
            ...
            <hr class="mt-10 mb-40 print:my-10" />
            <h2 id="section-3">Vajalikud eelteadmised viiruste kohta</h2>
            ...
            <hr  class="mt-10 mb-40 print:my-10" />
            <h2 id="section-5">Nõuded füüsilisele õppekeskkonnale</h2>
            ...
            <p><b>Tegevus 3</b> võib olla korraldatud kahel erineval viisil:</p>
