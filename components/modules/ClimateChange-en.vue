<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article print:not-prose" lang="en" style="hyphens: auto;">
            ...
            <p>Assessments that could be applied in this module:</p>
            ...
            <ul>
                ...
                <li>Peer feedback (on the group presentation using the following <a href="/tools/peer-feedback" target="_blank">following tool</a> and self-assessment after the game).</li>
                <li>Oral/written feedback from the teacher on individual / group worksheets.</li>
            </ul>
            
            <p><b>Summative:</b></p>
            <ul>
                <li>Grades assigned by the teacher on the group presentation (based on the students’ video, poster,  or similar and its performance and students’ ability to provide relevant answers/comments).</li>
            ...
            <section class="e-flow__chart">
                ...
                <div class="e-flow__boxes">
                    <div class="e-flow__box">
                        <p class="m-0 leading-tight mb-4"><b>Open-Inquiry Option</b></p>
                        <p class="m-0 leading-tight">Students make up their plan of action to obtain the necessary information. Different kinds of scientific sources are acceptable (e.g. experiments, scientific articles, etc.)</p>
                    </div>
                    <div class="e-flow__box">
                        <p class="m-0 leading-tight mb-4"><b>Guided-Inquiry Option</b></p>
                        <p class="m-0 leading-tight">Students study specifically given scientific sources (e.g. texts, videos, graphs, webpages, animations, maps, experimental procedures, etc.) and involve in specific activities answering specific questions.</p>
                    </div>
                </div>
                ...
                <div class="e-flow__box">
                    <ul class="m-0">
                        <li class="my-0 leading-tight">Students assess the reliability of specific sources using a specific tool.</li>
                        <li class="my-0 leading-tight">Students make justified conclusions based on the evidence found.</li>
                        <li class="my-0 leading-tight">Students come to the confirmation or falsification of their hypothesis.</li>
                    </ul>
                </div>
            </section>

            <p>The teacher could choose which option of Activity 3 students will use by considering their students' cognitive skills and the available teaching time. However, the open-inquiry option is considered the most challenging option for students.</p>


            <p>As reliability assessment can be a real challenge for students, the material is supplied with a tool for searching and analysing the information. Also, the teacher could explain its use by demonstrating and analysing reliable and less reliable sources as learning examples before the students implement this tool independently. </p>
            
            <p>To learn how to communicate their findings, students are guided to produce a video of their experiment as evidence or make a video of their conclusions based on secondary evidence (Activity 4). Student material is provided with criteria the video should fulfil. These criteria can be used formatively for self-assessment by students during the process and for peer assessment when presenting the video and answering the questions of their peers and the teacher (Activity 5). For the last, students can use the following assessment tool to give feedback to the other groups. The teacher could provide each group with summary feedback on their video presentation (suggestion: each group could access only their feedback, not the others). The teacher can easily access the feedback from Google Forms using the "Responses" button.</p>

            <p>In the last activity (Activity 6), the storyline of the module returns to the introductory video and the presented myths. Based on the lessons learned from the earlier stages, students prepare to make decisions on an individual or group level in a board game with cards where they have an opportunity to juxtapose and reflect on their learned science knowledge and their personal and social values. The rules of play are given in student worksheets. Students need to be instructed shortly before the start to understand the game's general flow.</p>

            <p>All myths are backed up by Scientific background information, which explains the state-of-the-art science behind them and enables the teacher to get a quick overview of the science covered by the "Climate Change" module but could also be used as learning material for students to recall climate change-related knowledge.</p>
