<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article print:not-prose" lang="et" style="hyphens: auto;">
            ...
            <section id="s-3">
                <h2 id="s-3t">Eeldatavad eelteadmised kliimamuutustest</h2>
            ...
            <section id="s-4">
                ...
                <p class="mt-20">
                    <b>Tabel 1.</b> Õpitegevuste järjestus kliimamuutuste moodulis
                </p>
                <table>
                    <thead>
                        <tr>
            ...
            <section id="s-5">
                <h2 id="s-5t">Nõuded füüsilisele õpikeskkonnale</h2>
                <p>
                    Nutitelefon, arvuti, internet, kuvaseadmed. Müütide eksperimentaalse purustamise kohta vt <a href="#section-7">“Õpetamissoovitused”</a>.
                </p>
            </section>
            ...
            <section id="s-7">
                ...
                <p>Kunstikooli õpilaste loomingulisi mõtisklusi kliimamuutuste ja keskkonnateemadel (vt <NuxtLink to="https://www.artsteps.com/view/6411276082afca1aa133e268" target="_blank">virtuaalnäitus</NuxtLink>) võib kasutada huvi tekitamiseks nimetatud nähtuste suhtes olles lähtepunktiks arutelule sellest, mida õpilased sooviksid antud valdkonnas tulevikus veel teada saada.
                </p>
            </section>
