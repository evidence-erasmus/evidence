<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article"  lang="en" style="hyphens: auto;">
            ...
            <section id="s-1">
                <h2 id="s-1-title">1. What is Climate Change, and which are its causes?</h2>
                <p>
            ...
            <section id="s-2">
                <h2 id="s-2-title">2. What are the effects of Climate Change?</h2>
            ...
            <section id="s-3">
                <h2 id="s-3-title">3. Techniques of Science Denial</h2>
            ...
            <section id="s-4">
                <h2 id="s-4-t" class="mt-40">4. Myths about Climate Change</h2>
                <h3><span class="text-rose-400">Myth 1:</span> The extinction of species is a natural process. Mass extinctions of species have always occurred.</h3>
                ...
                <h3><span class="text-rose-400">Myth 2:</span> Species / Organisms can adapt to climate change.</h3>
                ...
                <p>
                    <b>Click the following links for the scientific view:</b>
                </p>
                <ul>
                    <li>
                ...
                <h3>
                    <span class="text-rose-400">Myth 3:</span> The science of climate change is unreliable.
                </h3>
                <p>
                ...
                <h3><span class="text-rose-400">Myth 4:</span> The rise in temperature is for good.</h3>
                <p>
                    <i>"By the way, if you’re going to vote for something, vote for warming. Less deaths due to cold, regions more habitable, larger crops, longer growing season. That’s good. Warming helps the poor."</i> (John MacArthur)
                </p>
                <ul>
                    <li>
                ...
                <h3><span class="text-rose-400">Myth 5:</span> There's no correlation between CO₂ and temperature.</h3>
               <p>
                ...
                <h3><span class="text-rose-400">Myth 6:</span> Actions to mitigate climate change will make people poorer.</h3>
                ...
                <h3><span class="text-rose-400">Myth 7:</span> The earth’s climate has always changed, and now the same thing is happening.</h3>
                <p>
                    <i>
