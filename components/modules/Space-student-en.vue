...
<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article print:not-prose" lang="en" style="hyphens:auto;">
            ...
            <p>Please watch an introductory video (Earth Calls Martha). Write down your initial thoughts and feelings about the issues presented.</p>
...
<!-- 
 ...
 -->
            ...
            <hr class="mt-10 mb-40 print:my-10" />
            <h2 id="section-7">Activity 6: Debate role-play</h2>
