<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article" lang="et" style="hyphens: auto;">
            ...
            <section id="s-1">
                <h2 id="s-1-t">1. Mis on kliimamuutused ja millised on selle põhjused?</h2>
                <p>
                ...
                <p>
                    <b>Kasvuhooneefekti soodustavad gaasid (kasvuhoonegaasid) on järgmised:</b>
                </p>
                <dl>
                    ...
                    <dd>Tööstuslikku päritolu sünteetilised ühendid, mida kasutatakse mitmel otstarbel, kuid mida nüüd reguleeritakse suuresti rahvusvaheliste kokkulepete alusel, et vähendada nende tootmist ja sattumist atmosfääri, sest need aitavad kaasa osoonikihi hävimisele. Need on ka kasvuhoonegaasid.</dd>
                </dl>
                <UiContentImage
            ...
            <section id="s-2">
                <h2 id="s-2-t">2. Millised on kliimamuutuste tagajärjed?</h2>
                <p>Valitsustevaheline Kliimamuutuste Nõukogu (IPCC), kuhu kuulub rohkem kui 1300 teadlast erinevatest riikidest, viitab asjaolule, et kliimamuutuste mõju ulatus üksikutele piirkondadele on ajas erinev, mis sõltub ühtlasi erinevate ühiskonna- ja keskkonnasüsteemide võimest neid leevendada ja muutustega kohaneda.</p>
                <p>
            ...
            <hr class="mt-10 mb-40" />
            <section id="s-3">
                <h2 id="s-3-t">3. Kliimamuutus: Sotsiaalteaduslik ja vastuoluline probleem</h2>
            ...
            <section id="s-4">
                <h2 id="s-4t">4. Teaduse eitamise taktikad</h2>
            ...
            <section id="s-5">
                ...
                <h2 id="s-5t" class="mt-40">5. Kliimamuutustega seotud müüdid</h2>
                
                <h3>Müüt 1: Liigid suudavad kliimamuutustega kohaneda.</h3>
                ...
                <UiCardInfo class="my-8" theme="sky-500" icon="tabler:microscope">
                    <div>
                        ...
                        <p class="font-Heading text-2xl"><i>“Kõik liigid ei suuda kliimamuutustega kohaneda. Mõned liigid (nt linnud) võivad kliimamuutustega kohaneda erineval viisil (nt muuta rände- või pesitsusaega). Kuid mitte kõik liigid (nt imetajad) ei saa seda teha. Samuti ei ole võimalik kiiresti saavutada igasuguseid muutusi (nt morfoloogiliste omaduste muutumine). Üldiselt ei saa evolutsioon kiiresti toimuda ehk liikide kohanemise määr on enamasti ebapiisav. 
                        <br />
                        (Visser, 2008)”</i></p>
                    </div>
                </UiCardInfo>
                <p>Õpilased, kes uurivad müüti 1 juhitud uurimuse vormis, uurivad tõendeid selle kohta, kuidas liigid kliimamuutustega kohanevad (nt korallijuhtum), nad osalevad konkreetses korallide massimuutusi uurivas katses ning vaatlevad hiljutisi tõestusmaterjale kliimamuutuste mõju kohta imetajatele. Õpilased uurivad teadusallikaid ja teevad oma järeldused. Teise võimalusena koguvad õpilased, kes uurivad müüti 1 avatud uurimuse vormis, teaduslikest allikatest tõendeid, et oma hüpoteesi ümber lükata või kinnitada.</p>
                ...
                <h3>Müüt 2: Liikide väljasuremine on loomulik protsess. Liikide massiline väljasuremine on alati toimunud.</h3>
                ...
                <p>Õpilased, kes uurivad müüti 2 juhitud uurimuse vormis, uurivad tõendeid varasemate massiliste väljasuremiste kohta. Samuti uurivad nad uusimaid tõendeid konkreetsete kliimamuutustest põhjustatud väljasuremiste (nt Magellani pingviinide) kohta ja vaatavad BBC videot massiliste väljasuremiste kohta. Teise võimalusena koguvad õpilased avatud uurimuse vormis tõendeid teaduslikest allikatest, et oma hüpoteesi ümber lükata või kinnitada.</p>
                ...
                <h3>Müüt 3: Kliimamuutuste alane teadus ei ole usaldusväärne.</h3>
                <p>
                    <i>
                ...
                <h3>Müüt 4: Globaalne soojenemine on kasulik.</h3>
                ...
                <h3>Müüt 5: CO₂ ning temperatuuri vahel puudub seos.</h3>
                <p>
                ...
                <h3 id="section-11">Müüt 7: Maa kliima on alati muutunud ja nüüd kordub see taas.</h3>
                <p>
                    <i>
