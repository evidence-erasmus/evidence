<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article" lang="et" style="hyphens: auto;">
            ...
            <section id="s-2">
                <h2 id="s-2-t">2. Mis on kliimamuutuste tagajärjed?</h2>
            ...
            <section id="s-5">
                ...
                <p>
                    <i>
                        ...
                        <br />
                        Tegelikult leidsime, et 89 protsenti ilmajaamadest - peaaegu 9 kümnest - ei vasta riiklikult kehtestatud asukoha nõuetele, mille kohaselt peavad ilmajaamad olema 30 meetri (umbes 100 jalga) või kaugemal kunstlikust kütte- või kiirgavast/peegeldavast allikast/soojusallikast.”
                    </i> (Watts 2009)
                    <br />
