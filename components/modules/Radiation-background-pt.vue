<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article" lang="pt" style="hyphens: auto;">
            ...
            <p>
                Nos últimos anos, os estudantes e o público, em geral, estão cada vez mais interessados na radiação <sup><a href="https://doi.org/10.1119/1.4893090" target="_blank" rel="noopener noreferrer" title="Neumann, S. (2014). Three Misconceptions About Radiation — And What We Teachers Can Do to Confront Them, Physics Teacher, 52, 357;">[6]</a></sup>. Telemóveis, consolas de jogos modernos e Wi-Fi - todos os dispositivos que envolvem alguma radiação fazem parte do nosso dia-a-dia. As pessoas também são frequentemente confrontadas nos meios de comunicação social com debates relacionados com diferentes tipos de radiação: Toda a radiação é má! A radiação médica é mesmo necessária? A radiação dos telemóveis causa cancro? Os solários devem ser proibidos? Quais são os efeitos da contaminação nuclear das centrais nucleares?
            </p>
            ...
            <p>
                De acordo com várias agências de especialistas – não há nada que sugira que as ondas de 5G milímetros tenham um risco significativo para a saúde <sup><a href="http://emfhealth.info/research-expert-opinions.cfm" target="_blank" rel="noopener noreferrer">[7]</a></sup>. No entanto, muitos especialistas dizem que é necessária mais investigação de qualidade. As frequências de banda alta 5G ainda não são ionizantes, pelo que esta radiação não tem energia suficiente para quebrar o ADN e causar diretamente alterações nas células que podem levar ao cancro. A maioria dos estudos publicados sobre a utilização do serviço tradicional de telemóvel na gama de radiofrequências não encontraram uma ligação com o desenvolvimento de tumores <sup><a href="https://www.cancer.org/cancer/cancer-causes/radiation-exposure/cellular-phones.html" target="_blank" rel="noopener noreferrer">[8]</a></sup>. O aquecimento dos tecidos é o mecanismo primário de interação entre os campos de radiofrequência e o corpo humano. Os níveis de exposição à radiofrequência das tecnologias atuais (2, 3, 4G) resultam num aumento de temperatura negligenciável (algumas décimas de grau) no corpo humano.
            </p>

            <p>
                No entanto, alguns dos cientistas acima mencionados salientam que, no caso específico do 5G, a questão não é a potência, mas o pulso, a frequência a que toda a população estará exposta devido à densa rede de antenas e aos milhares de milhões estimados de ligações simultâneas. Estudos mostram que os campos eletromagnéticos pulsados (EMF) são, na maioria dos casos, biologicamente mais ativos e, portanto, mais perigosos do que o EMF não pulsado <sup><a href="https://www.europarl.europa.eu/RegData/etudes/BRIE/2020/646172/EPRS_BRI(2020)646172_EN.pdf" target="_blank" rel="noopener noreferrer">[9]</a></sup>.
            </p>

            <p>
                Assim, alguns especialistas suspeitam que a radiação destes dispositivos pode danificar as células através de outro mecanismo biológico, como o stress oxidativo nas células, o que leva à inflamação, e danos celulares e tecidos. Tem havido opiniões de que a exposição a curto prazo pode ter efeitos fisiológicos adversos no sistema nervoso periférico, no sistema cardiovascular <sup><a href="https://blogs.scientificamerican.com/observations/we-have-no-reason-to-believe-5g-is-safe/" target="_blank" rel="noopener noreferrer">[10]</a></sup> e no sistema imunitário (afetando a resposta imune na nossa pele) <sup><a href="https://www.investigate-europe.eu/en/posts/5g-covid-conspiracy" target="_blank" rel="noopener noreferrer">[11]</a></sup>. No entanto, estas opiniões são extraídas de alguns estudos, principalmente centrados nas bandas de frequência Wi-Fi (2,4 GHz e 5 GHz) <sup><a href="https://www.sciencedirect.com/science/article/pii/S0013935118300355" target="_blank" rel="noopener noreferrer">[12]</a></sup>.
            </p>
            ...
            <div class=" e-card">
                <div class="md:grid md:grid-cols-2 gap-4 md:items-end">
                    ...
                    <UiContentImage
                        ...
                        :elevated="false" >
                        <template #caption>
                            Germany <sup><a href="https://www.euronuclear.org/glossary/radiation-exposure-average-in-germany/" target="_blank" rel="noopener noreferrer">[15]</a></sup>
                        </template>
                    </UiContentImage>
                </div>
                <p class="text-sm italic text-center"><b>Figura 2.</b> Contribuição de diferentes fontes de radiação para a dose média anual de radiação efetiva da população</p>
            </div>
            ...
            <UiContentImage
                ...
                :elevated="true">
                <template #caption>
                    <b>Figura 4.</b> Instalação de irradiação alimentar de cobalto-60 de escala comercial e de tipo portador <sup>[24]</sup> 
                </template>
            </UiContentImage>
            
            <p>
                Atualmente, as pessoas estão mais conscientes da comida que comem do que em qualquer outra época da história. Mesmo que estas energias para a irradiação alimentar sejam demasiado baixas para induzir a radioatividade, algumas pessoas desconfiam dos alimentos irradiados. Embora a irradiação dos alimentos não tenha problemas toxicológicos, microbiológicos ou nutricionais <sup><a href="https://academic.oup.com/cid/article/33/3/376/278043" target="_blank" rel="noopener noreferrer">[21]</a></sup>, reduz os níveis de vitaminas nos alimentos, especialmente para as vitaminas do grupo B. No entanto, durante a cozedura tradicional, pode observar-se a perda de vitamina semelhante <sup><a href="https://academic.oup.com/cid/article/33/3/376/278043" target="_blank" rel="noopener noreferrer">[22]</a></sup>. A irradiação dos alimentos não tem nada a ver com a contaminação radioativa, uma vez que os alimentos não entram em contacto com materiais radioativos durante a irradiação e não podem ser contaminados desta forma.
            </p>
            ...
            <UiContentImage
                ...
                :elevated="true">
                <template #caption>
                    <b>Figura 5.</b> Esta instalação de irradiação de cobalto-60 é usada para testar a irradiação como uma ferramenta para a segurança alimentar. 
                </template>
            </UiContentImage>
            ...
            <p>
                Alguns grupos de lobby de bronzeamento interior dizem que, como as máquinas de bronzeamento usam principalmente luz UV, bronzear-se dessa forma é mais seguro do que deitar-se ao sol. Isto não é verdade. A radiação ultravioleta (UV) está classificada em UV (comprimento de onda de 320 a 400 nm), UVB (290 a 315 nm) e radiação UVC (100 a 280 nm). Durante anos, os cientistas acreditavam que os raios UVB são mais nocivos porque induzem a queimaduras solares ligadas ao melanoma. Sabemos que os raios UV induzem fotoaging e aumentam o risco de cancro da pele <sup><a href="https://www.health.harvard.edu/staying-healthy/is-a-tanning-bed-safer-than-sunlight" target="_blank" rel="noopener noreferrer">[23]</a></sup>. Portanto, não existe tal coisa como um bronzeado seguro ou saudável. Os raios UV, embora ligeiramente menos intensos que os UVB, penetram mais profundamente na sua pele. A exposição causa danos genéticos às células na parte mais interna da sua camada superior da pele, onde a maioria dos cancros de pele ocorrem. A pele tenta evitar mais danos escurecendo, resultando num bronzeado. A radiação UV é o tipo primário de luz usado na maioria das camas de bronzeamento. Uma vez que se pensa ser seguro, agora sabemos que é precisamente o oposto. Apenas uma sessão de bronzeamento interno pode aumentar o risco de desenvolver cancro da pele (melanoma em 20%, carcinoma escamoso da pilha em 67%, e carcinoma basocelular em 29%) <sup><span class="tooltip" data-tip="Wehner MR, Chren M, Nameth D, et al. International Prevalence of Indoor Tanning: A Systematic Review and Meta-analysis.JAMA Dermatol. 2014;150 (4): 390-400. doi:10.1001/jamadermatol.2013.6896."><span class="text-blue-600">[24]</span></span></sup>. A Academia Americana de Oftalmologia informa que as camas de bronzeamento produzem níveis de UV 100 vezes mais elevados ou a intensidade esperada da radiação ultravioleta do que o sol <sup><a href="https://www.aao.org/eye-health/tips-prevention/indoor-tanning-eye-safety" target="_blank" rel="noopener noreferrer">[25]</a></sup>. Isto reflete-se em tempos de bronzeamento curtos admissíveis (por exemplo, com pele branca ou pálida, mesmo uma sessão de um minuto).
            </p>
            ...
            <UiContentImage
                ...
                :elevated="true">
                <template #caption>
                    <b>Figura 6.</b> Efeitos UVA e UVB na pele humana <sup><a href="https://www.mdanderson.org/publications/focused-on-health/what-s-the-difference-between-uva-and-uvb-rays-.h15-1592991.html" target="_blank" rel="noopener noreferrer">[26]</a></sup>
                </template>
            </UiContentImage>
            ...
            <h2 id="section-myths">
                Factos relacionados com mitos comuns sobre a energia nuclear <sup><a href="https://funginstitute.berkeley.edu/news/op-ed-lets-dispel-the-myths-about-nuclear-energy/" target="_blank" rel="noopener noreferrer">[29]</a></sup> <sup><a href="https://ourworldindata.org/what-is-thesafest-form-of-energy" target="_blank" rel="noopener noreferrer">[30]</a></sup> 
            </h2>
            
            
            <h3><span class="text-rose-400">Mito 1:</span> A energia nuclear não é segura</h3>

            <p>
                Os três acidentes de reatores nucleares em Three Mile Island, Chernobyl e Fukushima Daiichi ocorreram durante um período de 65 anos. Destes três acidentes, dois não tiveram vítimas mortais relacionadas com radiações nucleares e Chernobyl teve cerca de 50 vítimas mortais imediatamente relacionadas com a radiação nuclear <sup><a href="https://www.who.int/news/item/05-09-2005-chernobyl-the-true-scale-of-the-accident" target="_blank" rel="noopener noreferrer">[31]</a></sup>. Embora mais 4.000 vítimas mortais resultantes do cancro possam estar relacionadas com o acidente de Chernobil, a taxa global de mortalidade continua a ser inferior à atribuída a outras formas de produção de energia. " O número de mortes causadas pela energia nuclear é 442 vezes inferior ao da lenhite por unidade de energia, mesmo tendo em conta as mortes por exposição radioativa <sup><a href="https://ourworldindata.org/what-is-thesafest-form-of-energy" target="_blank" rel="noopener noreferrer">[32]</a></sup>.”
            </p>

            <h3>
                <span class="text-rose-400">Mito 2:</span> A energia nuclear contribui para as emissões de carbono e conduz assim à poluição atmosférica e ao aquecimento global
            </h3>
            ...
            <h3><span class="text-rose-400">Mito 3:</span> Os resíduos nucleares precisam de ser armazenados durante 100000 anos</h3>
            ...
            <h3>
                <span class="text-rose-400">Mito 4:</span> As centrais nucleares emitem quantidades perigosas de radiação
            </h3>
            ...
            <h3><span class="text-rose-400">Mito 5:</span> A exposição à radiação só ocorre a partir de uma central nuclear</h3>
            ...
            <h3><span class="text-rose-400">Mito 6:</span> Não precisamos de energia nuclear na UE</h3>
            ...
            <h3><span class="text-rose-400">Mito 7:</span> As centrais nucleares estão a envelhecer e ineficientes</h3>
            ...
            <h3><span class="text-rose-400">Mito 8:</span>  Centrais nucleares podem explodir</h3>
            ...
            <h3><span class="text-rose-400">Mito 9:</span> Os resíduos nucleares não podem ser transportados com segurança.</h3>
            ...
            <h3><span class="text-rose-400">Mito 10:</span> Os trabalhadores das centrais nucleares são radioativos.</h3>
