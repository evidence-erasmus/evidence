    ...
    <div class="flex flex-col items-start 
        ...
        <section class="e-article" lang="pt" style="hyphens: auto;">
            ...
            <section id="s4">
                ...
                <h3>
                    <span class="text-rose-400">Mito 1:</span> A energia nuclear não é segura
                </h3>
                <p>
                ...
                <h3>
                    <span class="text-rose-400">Mito 3:</span> Os resíduos nucleares precisam de ser armazenados durante 100000 anos
                </h3>
                <p>
                ...
                <h3>
                    <span class="text-rose-400">Mito 5:</span> A exposição à radiação só ocorre a partir de uma central nuclear
                </h3>
                <p>
                ...
                <h3>
                    <span class="text-rose-400">Mito 6:</span> Não precisamos de energia nuclear na UE
                </h3>
                <p>
                ...
                <h3>
                    <span class="text-rose-400">Mito 7:</span> As centrais nucleares estão a envelhecer e ineficientes
                </h3>
                <p>
                ...
                <h3>
                    <span class="text-rose-400">Mito 8:</span>  Centrais nucleares podem explodir
                </h3>
                <p>
                ...
                <h3>
                    <span class="text-rose-400">Mito 9:</span> Os resíduos nucleares não podem ser transportados com segurança.
                </h3>
                <p>
                ...
                <h3>
                    <span class="text-rose-400">Mito 10:</span> Os trabalhadores das centrais nucleares são radioativos.
                </h3>
                <p>
