<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article" lang="et" style="hyphens:auto;">
            ...
            <section id="s1">
                <h2 id="s1t">1. Viirused versus bakterid</h2>
            ...
            <section id="s2">
                <h2 id="s2t">2. Miks antibiootikumid ei tapa viiruseid?</h2>
            ...
            <section id="s3">
                ...
                <h3>
                    Vaktsineerimine ja sellega seotud väljakutsed
                </h3>
                <p>
            ...
            <section id="s4">
                <h2 id="s4t">4. Vaktsiinide väljatöötamise protsess, vaktsiinide ohutus</h2>
            ...
            <section id="s5">
                <h2 id="s5t">5. Maskid viiruste ja bakterite vastu</h2>
            ...
            <section id="s6">
                <h2 id="s6t">6. Viirused ja käte hügieen</h2>
            ...
            <section id="s7">
                <h2 id="s7t">7. Vaktsiinidega seotud müüdid</h2>
