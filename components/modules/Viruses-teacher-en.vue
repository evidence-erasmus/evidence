<template>
    <div class="flex items-start">
        ...
        <section class="e-article print:not-prose">
            ...
            <div class="e-card flex flex-col items-center gap-4 pt-10 pb-20 bg-yellow-50 border-4 border-slate-300">
            ...
            <ul>
                ...
                <li>Peer feedback (on the group presentation using the <a href="/tools/videofeedback" target="_blank">following tool</a> and self-assessment after the game).</li>
            ...
            <p><b>Further, Activity 3 can be enacted in two ways:</b></p>
            <p>Students chose a myth that can be tested experimentally. From the given myths (see <a href="/viruses/student#activity-2">Activity 2</a>), only Myths 9 and 10 could be suitable for this purpose.</p>

            <ol>
                <li>
                    <p>The belief that <b>masks are pointless in preventing upper respiratory diseases</b> (e.g. COVID-19) can be developed further into a testable hypothesis or research question. It would be good to use different types of masks (e.g. textile masks, N95, surgical face masks) in this experiment to get more varied and exciting results. Practical examples of how it can be operationalized in the classroom - can be used if students are less experienced with the open inquiry format (there exist two versions, one in a more and the other in a less open inquiry format).</p>
