<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article"  lang="en" style="hyphens: auto;">
            ...
            <h2 id="section-2">2. Ποιες είναι οι επιπτώσεις της Κλιματικής Αλλαγής;</h2>
            ...
            <hr class="mt-10 mb-40" />
            <h2 id="section-3">3. Κλιματική Αλλαγή: Ένα κοινωνικο-επιστημονικό ζήτημα και αμφιλεγόμενο ζήτημα</h2>
            ...
            <hr class="mt-10 mb-40" />
            <h2 id="section-4">4. Τεχνικές της Επιστήμης της Άρνησης</h2>
            ...
            <h2 id="myth-1" class="mt-40">5. Μύθοι για την Κλιματική Αλλαγή</h2>

            <hr class="mt-10 mb-40" />
            <h2><span class="text-rose-400">Μύθος 1:</span> Η εξαφάνιση των ειδών είναι μια φυσική διαδικασία. Μαζικές εξαφανίσεις ειδών συνέβαιναν πάντα</h2>
            ...
            <h2><span class="text-rose-400">Μύθος 2:</span> Οι οργανισμοί μπορούν να προσαρμοστούν στις κλιματικές αλλαγές</h2>
            ...
            <h2><span class="text-rose-400">Μύθος 3:</span> Η επιστήμη της κλιματικής αλλαγής δεν είναι αξιόπιστη</h2>
            ...
            <h2><span class="text-rose-400">Μύθος 4:</span> Η αύξηση της θερμοκρασίας είναι για καλό</h2>
            ...
            <h2><span class="text-rose-400">Μύθος 5:</span> Δεν υπάρχει συσχέτιση μεταξύ CO₂ και θερμοκρασίας</h2>
            ...
            <h2><span class="text-rose-400">Μύθος 6:</span> Οι δράσεις για άμβλυνση της κλιματικής αλλαγής θα κάνουν τους ανθρώπους φτωχότερους</h2>
            ...
            <h2><span class="text-rose-400">Μύθος 7:</span> Το κλίμα της γης πάντα άλλαζε, και τώρα το ίδιο συμβαίνει</h2>
