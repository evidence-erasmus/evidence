<template>
    <div class="flex flex-col items-start 
        ...
        <section class="e-article" lang="et" style="hyphens: auto;">
            ...
            <h2 id="section-3">3. Ανακοινώσεις των μέσων μαζικής ενημέρωσης και ερευνητικά άρθρα που σχετίζονται με τις θεωρίες συνωμοσίας.</h2>
            ...
            <h2 id="section-4">4. Προϋπάρχουσες εκπαιδευτικές πηγές για την ενότητα της Ακτινοβολίας</h2>
