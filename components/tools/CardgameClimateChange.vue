...
<i18n lang="json">
{
    ...
    "et": {
        ...
        },
        {
            "title": "Üleujutused",
            "image": "card_c-change_floods.webp",
            "story": "“Meie maja jäi aeglaselt vee alla. Ja ühel ööl vesi tõusis ja läks mu peast kõrgemale.” 14-aastase Sathi elu pöördus pea peale, kui tema maja Bangladeshis Kurigramis üle ujutati ja ta pidi koos perega kolima ümberasustatud inimeste laagrisse. Ta kaotas üleujutustes kõik oma asjad ning laagrites elamine on tekitanud talle hirmu oma elu pärast."
        },
        {
            "title": "Kahjurid",
            "image": "card_c-change_pests.webp",
        ...
        },
        {
            "title": "Aastaajad",
            "image": "card_c-change_four-seasons.webp",
            "story": "Tavaliselt kogetakse USA-s igal aastal tavaliselt nelja aastaaega, kuid mõned teadlased ennustavad, et muutuv kliima muudab ka aastaaegade paigutust. Nelja võrdse pikkusega aastaaja asemel hakkab aastas domineerima vaid kaks aastaaega: talv ja suvi. Kevad ja sügis muutuvad lühikeseks üleminekuperioodiks aprillis ja oktoobris, kusjuures suurema osa aastast  domineerivad äärmuslikumad kuumad ja külmad perioodid. Uuringud on näidanud, et hooajaline soojenemine toimub kogu Ameerika Ühendriikides ebaühtlase tempoga ning talvine temperatuur tõuseb kiiremini kui suvised temperatuurid. Näiteks tõi hiljutine jugavool paljudesse linnadesse kaasa äärmuslikult madalad temperatuurid. Küll aga väheneb iga talvega keskmine päevade arv, mil temperatuur langeb alla 0 kraadi. Ennustatakse, et 2050. aastaks väheneb selliste päevade arv kahe kuu ulatuses üle kogu riigi ning eriti lõunaosariikide ja Vaikse ookeani loodeosa linnades."
        }
    ],
    "infoCards" : [
        {
