    ...
    "en": {
      ...
      "el": {
        ...
        "positionCards" : [
            {
                "title" : "Θέση 1",
                "position" : "Σε περίπτωση πανδημικής έκρηξης από ιούς του ανώτερου αναπνευστικού (π.χ. COVID-19), η πολιτεία καθιερώνει υποχρεωτική χρήση μάσκας σε δημόσιους χώρους (δημόσιες συγκοινωνίες, εμπορικά κέντρα, ιατρικά ιδρύματα, μαζικές εκδηλώσεις κ.λπ.), για όλους. Ανεξάρτητα από το αν οι άνθρωποι είναι εμβολιασμένοι κατά του συγκεκριμένου ιού ή όχι. Οι μάσκες παρέχονται δωρεάν και επιβάλλονται κυρώσεις σε άτομα που αρνούνται να φορέσουν."
            },
            {
                "title" : "Θέση 2",
