<template>
    <section class="bg-stone-50 shadow-md ">
        <nav class="h-10 container px-4 flex justify-start items-center gap-8">
            <NuxtLink to="`${route.path}`" class="flex items-center gap-2 uppercase font-bold transition-all"
            ...
            <NuxtLink :to="localePath(`${route.path}/student`)" class="flex items-center gap-2 font-bold transition-all"
            ...
            <NuxtLink :to="localePath(`${route.path}/background`)" class="flex items-center gap-2 font-bold transition-all"
